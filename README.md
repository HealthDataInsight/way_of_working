...
Organisations can create their own gem which defines the specific plugin dependencies which form their way of working. See the [HDI Way of Working](https://github.com/HealthDataInsight/hdi-way_of_working) as an example.
